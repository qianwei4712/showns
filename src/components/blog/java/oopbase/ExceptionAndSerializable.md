- [Java异常处理机制](#t1)
  - [ERROR（错误）](#t11)
  - [EXCEPTION（异常）](#t12)
    - [非检查性异常（unckecked exception）](#t121)
    - [检查性异常（ckecked exception）](#t122)
  - [异常处理](#t13)
  	- [抛出异常](#t131)
  	- [声明异常](#t132)
  	- [捕获异常](#t133)
...
若无法访问，还留有截图：<a href="https://gitee.com/qianwei4712/static_resources/raw/master/showns/images/SerializablePrinciple.png" target="_blank">https://gitee.com/qianwei4712/static_resources/raw/master/showns/images/SerializablePrinciple.png</a>
